...
枚举 VariableTextMarkingType       |  可以将各种动态字段设置为应用程序的短信： $ {Item. Label} $ {Item.Name} $ {Item. Location} $ {User.Name} $ {PrincipalName} $ {} $ {} $ {使用这些控件标志的值。
...
可以将各种动态字段设置为应用程序的短信： $ {Item. Label} $ {Item.Name} $ {Item. Location} $ {User.Name} $ {PrincipalName} $ {} $ {} $ {使用这些控件标志的值。
