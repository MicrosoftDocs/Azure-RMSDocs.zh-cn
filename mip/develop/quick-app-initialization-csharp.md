...
3. 重复上述步骤以添加 MIP SDK 文件 API 包，但改为将“Microsoft.IdentityModel.Clients.ActiveDirectory”添加到应用程序。
...
3. 为 Active Directory 身份验证库 (ADAL) 和 MIP 库添加 using 语句：
