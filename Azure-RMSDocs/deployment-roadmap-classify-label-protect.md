...
1. **自定义默认的 AIP 策略**。
    ...
    - **统一标签客户端：** [了解敏感度标签](/microsoft-365/compliance/sensitivity-labels)
...
1. **确定要管理租户密钥的方式**。
    ...
    > [!NOTE]
    > 根据你的客户端，可以使用其他选项 "保存你自己的密钥 (HYOK) " 或双密钥加密，以实现额外的安全性。 .
    >
...
1. **更新标签以应用保护**
    ...
    - 统一标签： [使用敏感度标签中的加密限制对内容的访问](/microsoft-365/compliance/encryption-sensitivity-labels)
