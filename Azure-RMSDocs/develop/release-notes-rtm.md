...
-   **改进日志记录以提高诊断性能** - 对于应审查的消息，日志记录级别将显示 **ERROR** 或 **WARNING**。 其他所有消息（包括仍会显示的异常）将记录为 **INFO**.
...
-   **文档更新**
    ...
    **重组** - [如何使用 ](how-to-use-msipc.md) 以阐明环境设置和应用程序测试的步骤顺序。

    **测试最佳实践** - 增加了有关在使用 Azure RMS 之前使用本地服务器的指导 有关详细信息，请参阅[使服务应用程序可与基于云的 RMS 一起使用](how-to-use-file-api-with-aadrm-cloud.md).
