...
RMS SDK 2.1 可在 Microsoft 下载中心的 [RMS SDK 2.1 下载页](https://www.microsoft.com/download/details.aspx?id=38397)处获取，用于创建一些自定义应用程序来实现数字资产的权限管理并强制实施这些资产的使用条款。 必须具备 C++ 编程语言的相关知识。

有关常见问题的答案，请参阅 [RMS 常见问题解答](https://aka.ms/adrmsfaq)的开发人员部分
...
|[开发人员注意事项](developer-notes.md)|本部分涵盖了几个重要开发方案的具体指南。|
...
* [RMS SDK 2.1 下载页面](https://www.microsoft.com/download/details.aspx?id=38397)
* [RMS 常见问题解答](https://aka.ms/adrmsfaq )
