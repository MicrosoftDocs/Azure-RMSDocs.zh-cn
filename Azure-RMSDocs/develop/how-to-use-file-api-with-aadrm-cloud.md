...
-   以下步骤适用于使用*其中 pccredential* ([Ipc \_ 凭据](https://msdn.microsoft.com/library/hh535275.aspx)创建[ipc \_ PROMPT \_ CTX](https://msdn.microsoft.com/library/hh535278.aspx)结构的实例，) 成员使用 Azure Rights Management 服务中的连接信息进行填充。
-   使用对称密钥服务标识创建中的信息 (参阅本主题前面列出的先决条件) 在创建[IPC \_ 凭据 \_ 对称 \_ 密钥](https://msdn.microsoft.com/library/dn133062.aspx)结构的实例时设置*wszServicePrincipal*、 *wszBposTenantId*和*cbKey*参数。
...
- 创建  [IPC \_ 凭据 \_ 对称 \_ 密钥](https://msdn.microsoft.com/library/dn133062.aspx) 的实例并设置几个成员。
...
有关详细信息，请参阅 [IPC \_ 凭据 \_ 对称 \_ 密钥](https://msdn.microsoft.com/library/dn133062.aspx)。

- 创建 [ipc \_ credential](https://msdn.microsoft.com/library/hh535275.aspx) 结构的实例，该结构包含 [ipc \_ 凭据 \_ 对称 \_ 密钥](https://msdn.microsoft.com/library/dn133062.aspx) 实例。
...
- 选择要用于加密的模板。
    在[IPC \_ 提示符 \_ CTX](https://msdn.microsoft.com/library/hh535278.aspx)的同一个实例中调用[IpcGetTemplateList](https://msdn.microsoft.com/library/hh535267.aspx) 。
...
- 利用本主题前面的模板，请调用 [IpcfEncrcyptFile](https://msdn.microsoft.com/library/dn133059.aspx)，并传入 [IPC \_ PROMPT \_ CTX](https://msdn.microsoft.com/library/hh535278.aspx)的同一个实例。
...
* [IPC \_ 提示符 \_ CTX](https://msdn.microsoft.com/library/hh535278.aspx)
* [IPC \_ 凭据](https://msdn.microsoft.com/library/hh535275.aspx)
* [IPC \_ 凭据 \_ 对称 \_ 密钥](https://msdn.microsoft.com/library/dn133062.aspx)
