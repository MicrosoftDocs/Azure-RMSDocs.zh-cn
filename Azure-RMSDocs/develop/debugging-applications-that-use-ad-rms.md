...
你可以使用以下注册表项启用调试跟踪。  (关闭调试跟踪，请将值更改为 0 ) 。在此版本中进行调试时，无需执行任何其他操作。
...
**注意**   在 "**视图**" 菜单上的 "Windows 事件查看器中，选择"**显示分析和调试日志**"，使 MSIPC 调试日志可见。
