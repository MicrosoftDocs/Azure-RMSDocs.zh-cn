...
|Feature  |描述  |
|---------|---------|
|**常用设备** </br>不仅仅是 Windows 计算机     | [客户端设备](requirements.md#client-devices)包括： </br></br>- Windows 计算机和手机 </br>- Mac 计算机 </br>- iOS 平板电脑和手机 </br>- Android 平板电脑和手机        |
