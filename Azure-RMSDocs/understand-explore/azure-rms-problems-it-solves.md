...
> [!TIP] 如果你熟悉 Rights Management 的本地版 Active Directory Rights Management Services (AD RMS)，可参阅[比较 Azure Rights Management 和 AD RMS](compare-azure-rms-ad-rms.md) 中的比较表。
