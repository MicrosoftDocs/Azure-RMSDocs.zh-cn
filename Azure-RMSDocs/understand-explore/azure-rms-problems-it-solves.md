...
|支持本地服务，以及 Office 365|√ 除了 [与 Office 365 无缝集成](applications-support.md) 以外，在部署 [RMS 连接器](../deploy-use/deploy-rms-connector.md) 时，你还可以将 Azure RMS 与以下本地服务结合使用：<br /><br />Exchange Server<br /><br />SharePoint Server<br /><br />运行文件分类基础结构的 Windows Server|
