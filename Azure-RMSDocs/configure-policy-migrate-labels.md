...
在 Outlook 中，保留保护，但有一个例外：如果已通过“仅加密”选项保护电子邮件，则去掉保护。
...
成功迁移的标签现在可被[支持统一标签的客户端和服务](#clients-and-services-that-support-unified-labeling)使用。 但是，你必须首先将[这些标签发布](/microsoft-365/compliance/create-sensitivity-labels#publish-sensitivity-labels-by-creating-a-label-policy)到一个管理中心：Office 365 安全与合规中心、Microsoft 365 安全中心或 Microsoft 365 合规中心。
...
迁移标签后，可以选择用于复制策略的选项。 如果选择此选项，策略的一次性副本及其[策略设置](configure-policy-settings.md)和任何[高级客户端设置](./rms-client/client-admin-guide-customizations.md#available-advanced-client-settings)将发送到管理标签的管理中心：Office 365 安全与合规中心，Microsoft 365 安全中心，Microsoft 365 合规中心。 
...
- 网络研讨会：[统一标签记录、卡片组和常见问题解答](https://github.com/nihendle/MIP-Comp/tree/master/MIP/Webinars/Unified%20Labeling%20Migration)
