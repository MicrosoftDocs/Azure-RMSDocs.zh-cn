...
---
# <a name="microsoft-software-license-terms-for-azure-information-protection"></a>Microsoft Azure 信息保护的软件许可条款
...
## <a name="2-data-collection"></a>2.数据收集
...
## <a name="7-binding-arbitration-and-class-action-waiver"></a>7.约束性仲裁和集体诉讼豁免
...
## <a name="8-entire-agreement"></a>8.完整协议
本协议，以及 Microsoft 可能提供的补充、更新或第三方应用程序的任何其他条款，组成软件的完整协议。

## <a name="9-applicable-law-and-place-to-resolve-disputes"></a>9.解决争议的适用法律和地点
...
## <a name="10-consumer-rights-regional-variations"></a>10.消费者权利；地区差异性
...
- a）澳大利亚。 你会受到澳大利亚消费者法提供的法律保证，本协议中的任何内容不会影响这些权利。
...
## <a name="french-franais"></a>法语 (Français)
