...
3. 在“添加权限”  边栏选项卡：要向组织中的用户授予权限，选择“添加 \< 组织名称> - 所有成员”  以选择租户中的所有用户。 此设置不包括来宾帐户。 或者，选择“浏览目录”  以选择特定组。 若要向外部用户授予权限或者键入电子邮件地址，请选择“输入详细信息”，然后键入用户或 Azure AD 组的电子邮件地址或键入域名  。
