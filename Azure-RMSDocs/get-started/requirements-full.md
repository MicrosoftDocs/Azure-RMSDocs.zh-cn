---
title: "Azure 信息保护的要求 - 全文 | Azure 信息保护"
...
-   对于联合租户（你在本地操作联合身份验证服务器）：
    ...
    -   为 Azure Active Directory 或 Office 365 配置联合身份验证服务器。 例如，如果你使用 AD FS，请参阅 TechNet 上的[为 AD FS 配置其他身份验证方法](https://technet.microsoft.com/library/dn758113.aspx)。
        ...
        有关此情况的详细信息，请参阅 Office 博客上的 [The Works with Office 365 – Identity program now streamlined](https://blogs.office.com/2014/01/30/the-works-with-office-365-identity-program-now-streamlined/)（使用 Office 365 – 标识程序现在已简化）。
