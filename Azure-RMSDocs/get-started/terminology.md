...
|项|定义|
|--------|--------------|
|AADRM|Azure Rights Management 的 Windows PowerShell 模块名称，派生自此前该应用名为 (Windows) Azure Active Directory Rights Management 时的 [!INCLUDE[aad_rightsmanagement_1](../includes/aad_rightsmanagement_1_md.md)] 的非正式缩写。|
...
|权限管理连接器|可为 Exchange Server 和 SharePoint 等本地服务部署的出站代理中继，用于通过 Azure Rights Management 保护数据。|
...
|使用许可证|向打开受 [!INCLUDE[aad_rightsmanagement_2](../includes/aad_rightsmanagement_2_md.md)] 保护的文件或电子邮件的用户授予的每文档证书。 该证书包含此用户对文件或电子邮件消息所具有的权限、用于加密内容的加密密钥，以及文档策略中定义的其他访问限制。|
