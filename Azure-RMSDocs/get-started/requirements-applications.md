...
要查看存储在 SharePoint Online 和 OneDrive for Business 中的文档，文档必须处于未受保护状态才能被上传到受保护的库中。
