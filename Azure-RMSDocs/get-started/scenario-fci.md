...
|下列情况之一：<br /><br />若要为所有用户使用默认模板：你尚未存档默认模板，&lt;组织名称&gt; - 机密<br /><br />- 若要为特定用户使用自定义模板：你已创建并发布此自定义模板|[为 Azure Rights Management 服务配置自定义模板](../deploy-use/configure-custom-templates.md)|
...
### <a name="configuring-a-file-server-to-protect-all-files-by-using-azure-rms-and-file-server-resource-manager-with-file-classification-infrastructure"></a>使用 Azure RMS 和带有文件分类基础结构的文件服务器资源管理器来配置保护所有文件的文件服务器。
...
### <a name="how-to-edit-lttype-of-filegt-from-the-ltfile-server-sharegt"></a>如何从&lt;文件服务器共享&gt;编辑&lt;文件类型&gt;
...
-   其他信息：
    ...
    -   [查看和使用受保护的文件](../rms-client/sharing-app-view-use-files.md)
...
#### <a name="how-to-edit-cad-drawings-from-the-projectnextgen-share"></a>如何从 ProjectNextGen 共享中编辑 CAD 绘图
