...
|公共|专为公共使用而准备和批准的业务数据。|**启用**：在上 <br /><br />**颜色**：绿色<br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
...
|公共|此信息是内部的，企业内部或外部的所有人均可使用。|**启用**：在上 <br /><br />**颜色**：绿色<br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
|内部|此信息包括各种可由所有员工使用并可与授权客户和业务合作伙伴共享的内部业务数据。 有关内部信息的示例包括公司策略和大多数内部通信。|**启用**：在上 <br /><br />**颜色**：蓝色 <br /><br />**可视标记**：页脚（文档和电子邮件）： <br /><br />敏感度：内部<br /><br />**条件**：无<br /><br />**保护**：无|
...
|Secret|此数据包括必须予以保护的高度敏感业务信息。 向未经授权的用户公开秘密数据可能会对组织造成严重损坏。 有关秘密信息的示例包括个人身份信息、客户记录、源代码和预先公布的财务报告。|**启用**：在上 <br /><br />**颜色**：红色<br /><br />**可视标记**：页脚（文档和电子邮件）：<br /><br /> 敏感度：Secret<br /><br />**条件**：无<br /><br />**保护**：无|
