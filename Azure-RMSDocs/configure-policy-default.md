...
|Label|工具提示|设置|
|-------------------------------|---------------------------|-----------------|
|个人|非业务数据，仅供个人使用。|**启用**：开 <br /><br />**颜色**：浅绿<br /><br />**可视标记**：关 <br /><br />**条件**：无<br /><br />**保护**：无|
|公用|专为公共使用而准备和批准的业务数据。|**启用**：开 <br /><br />**颜色**：绿色<br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
|常规|不公开使用的业务数据。 但是，可根据需要与外部合作伙伴共享该数据。 示例包括公司内部电话簿、组织结构图、内部标准和大部分内部通信。|**启用**：开 <br /><br />**颜色**：蓝色 <br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
|机密|与未经授权的人员共享时可导致业务损失的敏感业务数据。 例如合同、安全报告、预测摘要和销售客户数据。|**启用**：开 <br /><br />**颜色**：橙色<br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
|高度机密|与未经授权的人员共享时会导致业务损失的高度敏感业务数据。 例如员工和客户信息、密码、源代码和预先公布的财务报表。|**启用**：开 <br /><br />**颜色**：红色<br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
...
|Label|工具提示|设置|
|-------------------------------|---------------------------|-----------------|
|机密\所有员工|需保护的机密数据，所有员工具有完全权限。 数据所有者可跟踪和撤消内容。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为机密<br /><br />**条件**：无<br /><br />**保护**：Azure（云密钥）[[1]](#footnote-1)|
|机密\任何人（不受保护）|无需保护的数据。 使用此选项时需谨慎，并具有选择此选项的合理业务理由。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为机密 <br /><br />**条件**：无<br /><br />**保护**：无|
|机密\仅收件人|需要保护且仅收件人可以查看的机密数据。|**启用**：开 <br /><br />**可视标记**：页脚（电子邮件）<br /><br />归类为机密 <br /><br />**条件**：无<br /><br />**保护**：设置用户定义的权限（预览），在 Outlook 中应用“不转发”|
|高度机密\所有员工|高度机密数据，所有员工具有查看、编辑和回复此内容的权限。 数据所有者可跟踪和撤消内容。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为高度机密<br /><br />**条件**：无<br /><br />**保护**：Azure（云密钥）[[2]](#footnote-2)|
|高度机密\任何人（不受保护）|无需保护的数据。 使用此选项时需谨慎，并具有选择此选项的合理业务理由。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为高度机密<br /><br />**条件**：无<br /><br />**保护**：无|
...
|Label|工具提示|设置|
|-------------------------------|---------------------------|-----------------|
|机密\所有员工|需保护的机密数据，所有员工具有完全权限。 数据所有者可跟踪和撤消内容。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为机密<br /><br />**条件**：无<br /><br />**保护**：无|
|机密\任何人（不受保护）|无需保护的数据。 使用此选项时需谨慎，并具有选择此选项的合理业务理由。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为机密 <br /><br />**条件**：无<br /><br />**保护**：无|
|高度机密\所有员工|高度机密数据，所有员工具有查看、编辑和回复此内容的权限。 数据所有者可跟踪和撤消内容。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为高度机密<br /><br />**条件**：无<br /><br />**保护**：无|
|高度机密\任何人（不受保护）|无需保护的数据。 使用此选项时需谨慎，并具有选择此选项的合理业务理由。|**启用**：开 <br /><br />**可视标记**：页脚（文档和电子邮件）<br /><br />归类为高度机密<br /><br />**条件**：无<br /><br />**保护**：无|
...
|Label|工具提示|设置|
|-------------------------------|---------------------------|-----------------|
|秘密 \ 所有公司|此数据包括敏感业务信息 — 允许所有公司员工使用。|**启用**：开 <br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
|秘密 \ 我的组|此数据包括敏感业务信息 — 仅允许员工组使用。|**启用**：开 <br /><br />**可视标记**：关<br /><br />**条件**：无<br /><br />**保护**：无|
