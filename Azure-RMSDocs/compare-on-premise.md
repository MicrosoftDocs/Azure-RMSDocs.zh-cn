...
|支持的 Microsoft Office 最低版本为 Office 2010，它需要 [Azure 信息保护客户端](./rms-client/aip-client.md)或 RMS 共享应用程序。|支持的 Microsoft Office 最低版本为 Office 2010。|
