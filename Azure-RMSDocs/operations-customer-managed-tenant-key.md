...
1. 如果 Azure 信息保护尚未知道要使用的密钥，请运行 [AipServiceKeyVaultKey](/powershell/module/aipservice/use-aipservicekeyvaultkey) cmdlet。

1. 使用运行 [AipServiceKeyProperties](/powershell/module/aipservice/set-aipservicekeyproperties) cmdlet 配置租户密钥对象。
