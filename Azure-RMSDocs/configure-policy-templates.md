...
description: 配置和管理保护模板，也称为 rights management 模板，从 Azure 门户。
author: cabailey
ms.author: cabailey
manager: barbkess
ms.date: 06/12/2019
...
如果您获得的订阅一段时间以前，可能会使用以下名称创建默认模板：
...
- “已发布”和“已存档”设置在“标签”选项卡上    分别显示为“启用: 开”和   “启用: 关”   。 对于想要保留但对用户或服务不可见的模板，将其设置为“启用  : 关”  。
