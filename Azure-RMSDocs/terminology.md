...
|激活|若要启用保护服务（Azure Rights Management），以便组织可以保护其文档和电子邮件。 此操作还会在 Exchange Online 和 Microsoft SharePoint 中启用 IRM 功能。|
...
|内容密钥 (content key)|启用 RMS 的应用程序为使用 Rights Management 保护的每个文档或电子邮件创建的唯一密钥，有助于遏制信息泄漏的风险。|
...
|发布|用于保护某个文件，以防他人在未经授权的情况下访问和使用该文件。 还用作与保护模板和 Azure 信息保护策略结合使用的术语，以便这些项可供客户端和服务使用。|
