...
> 
> 如果要查找扫描程序当前预览版本的部署说明（包括 Azure 门户中的配置），请参阅[部署 Azure 信息保护扫描程序的预览版本以自动分类和保护文件](deploy-aip-scanner-preview.md)。
...
- 标识所有自定义条件和已知敏感信息类型。
    ...
    以下快速入门使用此配置：[快速入门：查找具有的敏感信息](quickstart-findsensitiveinfo.md)。
