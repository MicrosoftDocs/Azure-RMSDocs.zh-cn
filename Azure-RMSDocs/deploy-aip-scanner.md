...
> 
> 若要从早于1.48.204.0 的扫描仪的通用版本升级, 请参阅[升级 Azure 信息保护扫描程序](./rms-client/client-admin-guide.md#upgrading-the-azure-information-protection-scanner)。 然后, 可以使用此页上的说明, 省略安装扫描程序的步骤。
> 
> 如果尚未准备好从以前的版本进行升级, 请参阅[部署以前版本的 Azure 信息保护扫描程序以自动对文件进行分类和保护](deploy-aip-scanner-previousversions.md)。
