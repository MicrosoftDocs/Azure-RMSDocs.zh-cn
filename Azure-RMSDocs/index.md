...
控制并帮助保护你在公司防火墙外共享的电子邮件、文档和敏感数据。 从简单的分类到嵌入标签和权限，始终使用 Azure 信息保护增强对数据的保护，无论数据存储在何位置以及与谁共享。
        ...
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    ...
                    <div class="cardText">
                        <h3>观看 Microsoft Ignite 2016 中的 Azure 信息保护会话</h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/enterprise-mobility-security/solutions/infoprotect-secure-classify-scenario">开发人员指南</a></p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <li>
        <div class="cardSize">
            <div class="cardPadding">
                <div class="card">
                    <div class="cardText">
                        <p><a href="/enterprise-mobility-security/solutions/infoprotect-secure-classify-scenario">使用分类、标记和保护来保护数据</a></p>
                        <p><a href="/enterprise-mobility-security/solutions/share-sensitive-data">在内部和外部共享敏感数据</a></p>
                    </div>
                </div>
            </div>
        </div>
