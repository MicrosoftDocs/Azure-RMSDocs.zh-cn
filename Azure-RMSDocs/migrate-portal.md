...
|-----------|--------------------|
|首次访问配置设置|1.[登录到 Azure 门户](configure-policy.md#signing-in-to-the-azure-portal)。<br /><br />2.按照的说明，[首次访问 "Azure 信息保护" 窗格](configure-policy.md#to-access-the-azure-information-protection-pane-for-the-first-time)。
...
- 对其他管理员角色的支持：尽管你必须以全局管理员身份登录到 Azure 经典门户才能配置 Azure Rights Management，但你可以登录到 Azure 门户，通过使用包含**符合性管理员**和**相容性数据管理员**的其他许多管理角色来管理 azure 信息保护。 "[登录到 Azure 门户](configure-policy.md#signing-in-to-the-azure-portal)" 部分包含支持的角色的完整列表。
