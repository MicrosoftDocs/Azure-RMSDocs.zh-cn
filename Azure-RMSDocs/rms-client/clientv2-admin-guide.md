...
- 与 Azure Rights Management （Azure RMS）服务通信以加密和保护文件的 Rights Management 客户端。

除查看器外，Azure 信息保护统一标签客户端不能与直接与 Azure Rights Management 服务或 Active Directory Rights Management Services 通信的应用程序和服务一起使用。
