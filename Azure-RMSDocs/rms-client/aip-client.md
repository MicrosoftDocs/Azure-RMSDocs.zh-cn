---
title: 适用于 Windows 的 Azure 信息保护经典客户端
description: 适用于 Windows 的 Azure 信息保护经典客户端的信息资源。
author: batamig
ms.author: bagol
manager: rkarlin
ms.date: 03/16/2020
...
>
> ***相关** 内容：适用于 [Windows 的 Azure 信息保护经典客户端](../faqs.md#whats-the-difference-between-the-azure-information-protection-classic-and-unified-labeling-clients)。 有关统一的标记客户端，请参阅统一标签客户端 [管理员指南](clientv2-admin-guide.md) 和 [用户指南](clientv2-user-guide.md)。 *
