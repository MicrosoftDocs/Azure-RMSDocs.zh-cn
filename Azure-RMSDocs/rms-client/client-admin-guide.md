...
部署 Azure 信息保护客户端如果你不使用 Microsoft 365 中的 [敏感度标签](/microsoft-365/compliance/sensitivity-labels) ，而是使用从 azure 下载的 Azure 信息保护标签，则可使用以下任一项：
...
Azure 信息保护客户端支持的语言与 Microsoft 365 支持的语言相同。 有关这些语言的列表，请参阅 Office 中的 [国际可用性](https://products.office.com/business/international-availability) 页面。
