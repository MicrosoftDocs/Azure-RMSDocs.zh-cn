...
2. 对于默认安装，只需运行可执行文件 **AzInfoProtection.exe**。 但是，若要查看安装选项，请先使用 **/help** 运行可执行文件：`AzInfoProtection.exe /help`
...
## <a name="to-verify-installation-connection-status-or-send-feedback"></a>验证安装、连接状态或发送反馈
