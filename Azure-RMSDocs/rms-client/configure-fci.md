...
- 这种情况下不支持部门模板，因此必须使用未配置的模板作用域，或者使用[集 AipServiceTemplateProperty](/powershell/module/aipservice/set-aipservicetemplateproperty) cmdlet 和*EnableInLegacyApps*参数。
