...
**Azure 信息保护统一标签客户端**从管理中心下载标签和策略设置： Office 365 安全与合规中心、Microsoft 365 安全中心和 Microsoft 365 符合性中心。 有关此客户端的详细信息，请参阅[Azure 信息保护统一标签客户端：版本发行信息](unifiedlabelingclient-version-release-history.md)。 
