...
若要更新你的租户密钥，请按照[计划和实现你的 Azure Rights Management 租户密钥](..\plan-design\plan-implement-tenant-key.md)主题中的[实现自带密钥 (BYOK)](..\plan-design\plan-implement-tenant-key.md#implementing-your-azure-rights-management-tenant-key) 部分中的程序，通过 Internet 或亲自生成并创建新的密钥。
