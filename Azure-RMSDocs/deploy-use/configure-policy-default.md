...
请注意，此策略中的说明适用于需要保护的数据，以及数据跟踪和撤消。 该策略未针对这些标签配置此保护，所以必须执行额外步骤来实现此说明内容。 例如，配置标签以应用 Azure RMS 保护或使用数据丢失防护 (DLP) 解决方案。 必须先通过 Azure RMS 保护文档，并且由保护文档的人员跟踪文档，才能使用文档跟踪站点跟踪和撤消文档。 
