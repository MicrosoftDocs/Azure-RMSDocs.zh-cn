...
-   管理员信息
    ...
    有关详细信息，请参阅[应用程序如何支持 Azure Rights Management 服务](../understand-explore/applications-support.md)和[为 Azure Rights Management 服务配置应用程序](configure-applications.md)。
...
-   技术支持信息
    ...
    - 与保护或使用内容相关的问题
        ...
        如果用户拥有的权限与预期不同，请查看[使用权限表](../deploy-use/configure-usage-rights.md#usage-rights-and-descriptions)中的权限说明和任何特定于应用程序的实现。
